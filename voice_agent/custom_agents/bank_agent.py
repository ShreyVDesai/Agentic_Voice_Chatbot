...
guardrail_agent = Agent(
    ...
    instructions="You are a helpful assistant. You should check if the user's prompt contains anything obscene or inappropriate. If not, then don't trigger the tripwire",
